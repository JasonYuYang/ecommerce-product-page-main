...
module.exports = (webpackEnv) => {
            ...
            plugins: [
              ...
              isEnvProduction && [
                '@fullhuman/postcss-purgecss', // 删除未使用的css
                {
                  content: [
                    paths.appHtml,
                    ...glob.sync(path.join(paths.appSrc, '/**/*.{tsx,ts,js,jsx}'), { nodir: true }),
                  ],
                },
              ],
              [
  ...
  return {
    ...
    output: {
      ...
      filename: isEnvDevelopment ? '[name].js' : '[name].[contenthash:8].js', // 打包文件输出名称
      chunkFilename: isEnvDevelopment ? '[name].js' : '[name].[contenthash:8].js',
      ...
      rules: [
        {
          oneOf: [
            ...
            // 处理css文件
            {
              ...
              include: [paths.appSrc, paths.swiperPath],
              use: getStyleLoader(),
            },
            // 处理sass文件
            {
